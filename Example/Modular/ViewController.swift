...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        view1.place.on(canvas1, height: 20).sideToSide()
        ...
        leftView1.place.on(canvas2).rectangle(width: 30, height: 30).with.leftMargin().and.minBottomMargin()
        
        let rightView1 = RandomView()
        rightView1.place.on(canvas2).rectangle(width: 30, height: 10).with.rightMargin().minBottomMargin()
